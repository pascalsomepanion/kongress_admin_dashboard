      ...
      {edit&&(
        <Modal title={edit.id?'Kurs bearbeiten':'Kurs anlegen'} onClose={()=>setEdit(null)}>
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            <Field label="ÖÄK-Kategorie (z.B. Grundkurs / Theorie 5h & Praxis 5h)" id="k-ok" value={(edit as any).oeak_kategorie??''} onChange={v=>setEdit({...edit,oeak_kategorie:v} as any)} span2/>
