...
const NAV=[{href:'/admin',label:'Dashboard',icon:'📊'},{href:'/admin/teilnehmer',label:'Teilnehmer',icon:'👥'},{href:'/admin/buchungen',label:'Buchungen',icon:'💶'},{href:'/admin/rechnungen',label:'Rechnungen',icon:'🧾'},{href:'/admin/sponsoren',label:'Sponsoren',icon:'🏢'},{href:'/admin/kurse',label:'Kurse',icon:'📚'},{href:'/admin/kongress',label:'Kongress',icon:'🏆'},{href:'/admin/export',label:'Export',icon:'📥'}]
