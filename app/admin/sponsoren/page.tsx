...
export default function SponsorenPage(){
  ...
  async function createStornoPreview(r:SponsorRechnung){
    ...
    <style>@page{size:A4;margin:15mm 20mm 25mm 20mm}*{box-sizing:border-box;margin:0;padding:0}body{font-family:Arial,sans-serif;font-size:11px;color:#111}@media print{body{-webkit-print-color-adjust:exact}}</style>
    </head><body>
