...
export default function SponsorenPage(){
  ...
  async function createStornoPreview(r:SponsorRechnung){
    ...
    <style>@page{size:A4;margin:15mm 20mm 25mm 20mm}*{box-sizing:border-box;margin:0;padding:0}body{font-family:Arial,sans-serif;font-size:11px;color:#111;min-height:297mm;display:flex;flex-direction:column;}@media print{body{-webkit-print-color-adjust:exact}}</style>
    </head><body>
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8mm;padding-bottom:5mm;border-bottom:2px solid #FFBF00"><div style="display:flex;align-items:center;gap:8px"><img src="/logo.svg" style="height:16mm;width:auto" onerror="this.style.display='none'"/><div><div style="font-size:11px;font-weight:700;color:#111">Prof. h.c. Univ.-Doz. Dr. Günther Neumayr</div><div style="font-size:9px;color:#777">Österreichische Gesellschaft für Sportmedizin und Prävention</div></div></div><div style="text-align:right;font-size:10px;color:#555;line-height:1.7"><div>${new Date().toLocaleDateString('de-AT')}</div><div>Bearbeiterin: Dr. iur. Mara Neumayr, MBL</div><div>E-Mail: info@sportmedizin-arlberg.at</div></div></div>
