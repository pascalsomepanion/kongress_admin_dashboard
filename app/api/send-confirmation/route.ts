  ...
  const{error}=await resend.emails.send({
    ...
    html:`<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
      <div style="background:#FFBF00;padding:28px 36px;border-radius:10px 10px 0 0">
        ...
        <h1 style="font-size:20px;font-weight:800;color:#111;margin:0">Anmeldebestätigung</h1>
      ...
      <div style="padding:28px 36px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 10px 10px">
        <p style="font-size:14px;margin:0 0 6px">Liebe/r ${vorname} ${nachname},</p>
        <p style="font-size:13px;color:#666;line-height:1.6;margin:0 0 20px">vielen Dank für Ihre Anmeldung. Bitte überweisen Sie den Gesamtbetrag auf das untenstehende Konto. Nach Zahlungseingang erhalten Sie eine Rechnung.</p>
        ...
        <div style="background:#FFF9E6;border:1px solid #FFE082;border-radius:10px;padding:18px 22px;margin:0 0 20px">
          ...
          <table style="width:100%;font-size:12px;border-collapse:collapse">
            <tr><td style="color:#999;padding:3px 0;width:130px">Betrag</td><td style="font-weight:800;font-size:16px;color:#B45309">€ ${(gesamtbetrag as number).toFixed(2)}</td></tr>
